"""
Configuration module for JEPA-SVM API application.
...
class Settings(BaseSettings):
    ...
    # API Configuration
    api_title: str = Field(default="JEPA-SVM API", description="API Title")
    api_description: str = Field(default="API for JEPA-SVM pipeline and classification tasks",
    ...
    jepa_epochs: int = Field(default=200, description="JEPA training epochs")
    jepa_lr: float = Field(default=0.001, description="JEPA learning rate")
    jepa_hidden_dim: int = Field(default=64, description="JEPA hidden dimension")
    jepa_embedding_dim: int = Field(default=32, description="JEPA embedding dimension")
